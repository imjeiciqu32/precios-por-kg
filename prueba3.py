...
#   3. NAVEGACIÓN, MONEDA (Europa + Canadá + Brasil) Y LÓGICA DE MODOS
...
with st.sidebar:
    ...
    # --- SELECTOR DE MONEDA (Europa + Canadá + Brasil) ---
    ...
    MONEDAS_DISPONIBLES = ["USD", "CAD", "EUR", "BRL"]
    SIMBOLOS_MONEDA = {
        "USD": "$", "CAD": "CA$", "EUR": "€", "BRL": "R$",
    }
    # Tasas de referencia respecto a USD (EDITABLES abajo). Son aproximadas y deben
    # actualizarse periódicamente — sobre todo EUR/USD y BRL/USD, que se mueven bastante.
    TASAS_CAMBIO_DEFAULT = {
        "USD": 1.0, "CAD": 1.35, "EUR": 0.92, "BRL": 5.50,
    }
